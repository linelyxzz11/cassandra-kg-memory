...
def build_full5_rankings(questions: dict[str, dict], mem: dict,
    ...
    if method == "BM25":
        legacy_name = "BM25"
        sample_path = ROOT / "results/retrieval/official_eval/bm25_raw_ranking_canonical1540.csv"
        ranking = load_ranking(sample_path, 50)
    elif method == "Dense-bge":
        legacy_name = "Dense-bge"
        sample_path = ROOT / "results/retrieval/official_eval/dense_bge_ranking_canonical1540.csv"
        ranking = load_ranking(sample_path, 50)
    elif method == "Dense+GlobalKG":
        legacy_name = "Dense-bge+GlobalKG"
        sample_path = ROOT / "results/retrieval/dense_global_kg_rerun/dense_global_kg_top10.csv"
        ...
        dense_fallback = load_ranking(
            ROOT / "results/retrieval/official_eval/dense_bge_ranking_canonical1540.csv",
            50,
        )
        ...
        legacy_name = "Dense-bge"
        sample_path = ROOT / "results/retrieval/official_eval/zscore_raw_ranking_canonical1540.csv"
        ranking = load_ranking(sample_path, 50)
    elif method == "RRF_compact":
        legacy_name = "Dense-bge"
        sample_path = ROOT / "results/retrieval/official_eval/rrf_compact_canonical1540/rrf_compact_top10.csv"
        ranking = load_ranking(sample_path, 50)
    elif method == "ZScore-RawERK":
        legacy_name = "Dense-bge"
        sample_path = ROOT / "results/retrieval/official_eval/zscore_rawerk_ranking_canonical1540.csv"
        ranking = load_ranking(sample_path, 50)
    else:
