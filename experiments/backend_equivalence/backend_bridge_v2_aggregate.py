...
contract under::
    ...
    results/backend_equivalence/backend_equivalence_v2/runs/{csv,cassandra,neo4j}/
        top10.csv
...
DEFAULT_INPUT = ROOT / "results" / "backend_equivalence" / "backend_equivalence_v2" / "runs"
DEFAULT_OUTPUT = ROOT / "results" / "backend_equivalence" / "backend_equivalence_v2"
DEFAULT_GOLD = (
    ROOT
    / "data"
    / "retrieval_gold"
...
FROZEN_REFERENCES = {
    "BM25": ROOT / "results" / "retrieval" / "official_eval" / "bm25_raw_ranking_canonical1540.csv",
    "Dense-bge": ROOT / "results" / "retrieval" / "official_eval" / "dense_bge_ranking_canonical1540.csv",
    "Dense+GlobalKG": (
        ROOT / "results" / "retrieval" / "dense_global_kg_rerun" / "dense_global_kg_top10.csv"
    ),
    "RRF_compact": (
        ROOT
        / "results"
    ...
    "ZScore-Raw": ROOT / "results" / "retrieval" / "official_eval" / "zscore_raw_ranking_canonical1540.csv",
    "ZScore-RawERK": (
        ROOT / "results" / "retrieval" / "official_eval" / "zscore_rawerk_ranking_canonical1540.csv"
    ),
}
