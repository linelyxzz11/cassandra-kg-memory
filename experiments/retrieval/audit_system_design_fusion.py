...
P1 = ROOT / "experiments/retrieval/p1_compact_component_ablation/run_p1c_ablation_v5.py"
ONLINE = ROOT / "src/cassmem/retrieval/online.py"
BRIDGE = ROOT / "experiments/backend_equivalence/backend_bridge_v2_run.py"
...
def main():
    ...
    manifest_path = ROOT / "results/representation_ablation/p1_compact_component_ablation/p1c_run_manifest.json"
    ...
    memories = list(rows(ROOT / "data/locomo_memory_records.csv"))
    features = {row["memory_id"]: row for row in rows(ROOT / "data/frozen_retrieval/p3_memory_features.csv")}
    ...
    for row in rows(ROOT / "data/frozen_retrieval/frozen_dense_scores_long.csv"):
    ...
    sparse_path = ROOT / "results/representation_ablation/p1_compact_component_ablation/p1c_bm25_rankings_cat1_4_1540.csv"
    ...
    sparse = {}
    for row in rows(ROOT / "data/retrieval_gold/locomo_cat1_4_gold_memory.csv"):
    ...
    reference_path = ROOT / "results/retrieval/official_eval/zscore_rawerk_ranking_canonical1540.csv"
