...
RUNNER_PATH = ROOT / "src/cassmem/evaluation/run_locomo_prompt_protocol_gpt4o.py"
OUTPUT_ROOT = ROOT / "results/reader/locomo_gpt4o_prompt_protocol_corrected_densekg_v2"
...
def main() -> None:
    runner = load_runner()
    questions = runner.load_questions(ROOT / "data/locomo_qa_records.csv")
    memories = runner.load_memory_text(ROOT / "data/locomo_memory_records.csv")
