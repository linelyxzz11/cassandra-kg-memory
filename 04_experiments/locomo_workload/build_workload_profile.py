...
DEFAULT_OUTPUT = ROOT / "05_reports" / "locomo_workload_profile"
...
def main() -> None:
    ...
    memory_path = ROOT / "01_data" / "locomo_memory_records.csv"
    qa_path = ROOT / "01_data" / "locomo_qa_records.csv"
    feature_path = ROOT / "02_artifacts" / "p3_memory_features.csv"
    memory_ids_path = ROOT / "01_data" / "locomo_memory_ids_bge.txt"
    qa_ids_path = ROOT / "01_data" / "locomo_qa_ids_bge.txt"
