...
DATA = ROOT / "01_data"
QUESTIONS = ROOT / "02_artifacts/retrieval_gold_v2/locomo_cat1_4_gold_memory.csv"
MEMORIES = DATA / "locomo_memory_records.csv"
FEATURES = ROOT / "02_artifacts/p3_memory_features.csv"
EDGES = ROOT / "results/locomo_kg_edges_spacy.csv"
...
DENSE_SCORES = ROOT / "scripts/experiments/artifacts/frozen_dense_scores_long.csv"
OUTPUT_ROOT = ROOT / "05_reports/backend_equivalence_v2/runs"
